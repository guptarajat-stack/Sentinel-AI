...
exports.generateGeoData = generateGeoData;
 ...
 */
function generateGeoData(ip) {
    if (ipGeoCache.has(ip)) {
        return ipGeoCache.get(ip);
    }
    const template = (0, random_1.randomElement)(GEO_TEMPLATES);
    const cityInfo = (0, random_1.randomElement)(template.cities);
    const geoData = {
        ...
        lat: cityInfo.lat,
        lon: cityInfo.lon,
        isp: (0, random_1.randomElement)(template.isps),
    };
