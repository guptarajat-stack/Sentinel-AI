...
exports.simulateSqlInjection = simulateSqlInjection;
...
function simulateSqlInjection() {
    ...
    const payload = (0, random_1.randomElement)(constants_1.SQLI_PAYLOADS);
    ...
    const dbPid = (0, random_1.randomInt)(100, 32000);
